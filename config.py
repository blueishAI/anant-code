...
class AnantConfig:
    ...
    seq_len: int = int(os.getenv("ANANT_SEQ_LEN", "2048"))
    ...
    lora_r: int = int(os.getenv("ANANT_LORA_R", "16"))
    lora_alpha: int = int(os.getenv("ANANT_LORA_ALPHA", "32"))
    ...
    def system_prompt(self) -> str:
        return (
            ...
            "- If a task is ambiguous, use AskUser before proceeding.\n"
            "- Only use tools when they are available and necessary.\n"
